...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "abraheman.744@gmail",
    href: "mailto:abraheman.744@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/abdul-raheman-3285502b8",
    content: "/Abdul Raheman",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/AbdulRaheman74",
    ...
    <div className="container mx-auto px-4 md:px-[50px] xl:px-[200px] text-zinc-300 pt-20 pb-20">
      <div className="flex flex-col lg:flex-row gap-5">
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            <h1 className="text-3xl mb-10 lg:mb-20">About Me</h1>

            <p className="mb-10 text-roboto">
              Hey there! I&apos;m <strong>Abdul Raheman</strong>, a Computer
              Science Engineer with 1.5 years of experience in Development,
              DevOps, and Database Management. I have hands-on expertise in
              deploying and automating workflows, collaborating with
              international clients, and improving system performance.
            </p>

            <p className="mb-10 text-roboto">
              I pride myself on strong analytical thinking, effective
              communication, and a team-oriented mindset that helps drive
              process improvements and deliver reliable results across projects.
            </p>

            <p className="mb-10 text-roboto">
              When I&apos;m not coding, you&apos;ll likely find me exploring new
              technologies, learning cloud tools, contributing to open-source,
              or sipping coffee while brainstorming my next big project.
            </p>
