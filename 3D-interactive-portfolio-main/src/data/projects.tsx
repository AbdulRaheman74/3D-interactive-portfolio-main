...
const projects: Project[] = [
  ...
  // +
 {
  ...
  title: "MPGI College Website",
  src: "/assets/projects-screenshots/aidockerfileoptimizer/2.png", // 👈 Yeh MPGI thumbnail hai
  screenshots: ["1.png", "2.png", "3.png"], // 👈 Yeh bhi MPGI wale screenshots hain
  live: "https://mpgi.ac.in/",
  github: "",
  skills: {
  ...
  get content() {
    return (
      <div>
        <TypographyP className="font-mono ">
          This is the official website of MPGI (Maharana Pratap Group of Institutions), built to present 
          all academic programs, admission details, campus life, and placement opportunities. The 
          website is fully responsive and built with semantic HTML, modern CSS, and JavaScript for 
  ...
  {
  id: "muskanbeautyparlour",
  category: "Business Website",
  title: "Muskan Beauty Parlour",
  src: "/assets/projects-screenshots/financeme/1.png", // 👈 Thumbnail image (first image)
  screenshots: ["1.png", "2.png", "3.png"], // 👈 These images are inside `financeme` folder
  live: "http://www.muskanbeautyparlour.com",
  github: "", // Add repo if needed
  skills: {
  ...
  get content() {
    return (
      <div>
        <TypographyP className="font-mono ">
          Muskan Beauty Parlour is a fully responsive React-based website designed to showcase a range
          of beauty services. Built with Tailwind CSS, it ensures a smooth, elegant UI that works
          perfectly on mobile and desktop. The site features a services section, image gallery,
          appointment info, and contact form to enhance client engagement.
        </TypographyP>
...

 {
  ...
  title: "TekiskyMart",
  src: "/assets/projects-screenshots/savinderpuriportfolio/1.png", // 👈 Thumbnail image
  screenshots: ["01.png", "02.png", "03.png"], // 👈 Inside smartjobtracker folder
  live: "https://tekiskymart.com/",
  ...
  get content() {
    return (
      <div>
        <TypographyP className="font-mono">
          TekiskyMart is a responsive e-commerce platform for selling mobile accessories and electronic products. 
          Built using React, Tailwind CSS, and Firebase, it allows smooth navigation, cart operations, 
          and secure order placement. The UI is optimized for both desktop and mobile users.
        </TypographyP>
  ...
  //           transforms lives. 💻🕊️ Crafted with ❤️ by ! 🚀
  //         </TypographyP>
  //         <ProjectsLinks live={this.live} repo={this.github} />
  //         <SlideShow
  //           images={[
