...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const text = `Hello, my name is ${fullName}. My email is ${email}. Here's my message:\n\n${message}`;
      const whatsappUrl = `https://wa.me/7448058032?text=${encodeURIComponent(text)}`;
      ...
      toast({
        ...
        description: "You will be redirected to send the message.",
        variant: "default",
